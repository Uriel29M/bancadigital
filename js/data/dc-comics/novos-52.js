(function () {
  ...
  const catalog = [
    ...
    ["series-antes-de-watchmen-2012-novos-52", "Antes de Watchmen", "Before Watchmen", "Vários autores", "Watchmen", "Minisséries que exploram o passado de personagens do universo de Watchmen.", "before-watchmen-2012/before-watchmen-ozymandias-1", "https://hqs-soquadrinhos.blogspot.com/2011/08/antes-de-watchmen-comediante-2012.html", 36, "https://i.imgur.com/Vra4Nsr.jpg"],
  ...
  // Links e capas na ordem das oito seções da página de Antes de Watchmen.
  // IDs sequenciais preservam as referências existentes; a numeração reinicia por volume.
  const watchmenId = "series-antes-de-watchmen-2012-novos-52";
  const watchmenItems = [
  {
    ...
    "collectionIds": [],
    "downloadCount": 0,
    "catalogEditedAt": "2026-09-09T05:04:44.431Z",
  ...
  },
  {
    ...
    "coverUrl": "https://i.postimg.cc/x8V9GjZC/comedian5sm.jpg"
  },
  {
  ...
  window.DEFAULT_LIBRARY = window.DEFAULT_LIBRARY.filter(item => item.seriesId !== watchmenId);
  window.DEFAULT_LIBRARY.push(...watchmenItems);
