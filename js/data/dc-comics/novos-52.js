(function () {
  ...
  const catalog = [
    ...
    ["series-all-star-secao-oito-2015-novos-52", "All-Star Seção Oito", "All Star Section Eight", "Garth Ennis / John McCrea", "Sixpack", "Sixpack reúne novamente a equipe Seção Oito para enfrentar uma ameaça em Gotham.", "all-star-section-eight-2015/all-star-section-eight-1", "http://hqs-soquadrinhos.blogspot.com/2015/06/secao-oito-2015.html", 4, ""],
