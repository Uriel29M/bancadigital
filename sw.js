const CACHE_VERSION = "banca-digital-shell-v672-series-mobile-page";
const SHELL_CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./", "./index.html", "./css/style.css?v=2.2.10.257-series-mobile-page",
  "./js/app.js?v=2.2.10.519-series-mobile-page", "./js/reader-deps.js?v=3-reader-split", "./js/catalog-sync.js?v=5-catalog-created-at",
