const CACHE_VERSION = "banca-digital-shell-v664-profile-cleanup";
const SHELL_CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./", "./index.html", "./css/style.css?v=2.2.10.249-profile-cleanup",
  "./js/app.js?v=2.2.10.512-profile-cleanup", "./js/reader-deps.js?v=3-reader-split", "./js/catalog-sync.js?v=5-catalog-created-at",
