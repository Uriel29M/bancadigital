const CACHE_VERSION = "banca-digital-shell-v691-home-clean";
const SHELL_CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./", "./index.html", "./css/style.css?v=2.2.10.265-home-clean",
  "./js/app.js?v=2.2.10.540-home-clean", "./js/reader-deps.js?v=3-reader-split", "./js/catalog-sync.js?v=5-catalog-created-at",
