const CACHE_VERSION = "banca-digital-shell-v661-chat-split";
const SHELL_CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./", "./index.html", "./css/style.css?v=2.2.10.248-novelty-badge",
  "./js/app.js?v=2.2.10.509-chat-split", "./js/reader-deps.js?v=3-reader-split", "./js/catalog-sync.js?v=5-catalog-created-at",
