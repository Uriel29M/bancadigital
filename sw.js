const CACHE_VERSION = "banca-digital-shell-v689-auth-gated";
const SHELL_CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./", "./index.html", "./css/style.css?v=2.2.10.264-faction-chat-black",
  "./js/app.js?v=2.2.10.538-auth-gated", "./js/reader-deps.js?v=3-reader-split", "./js/catalog-sync.js?v=5-catalog-created-at",
