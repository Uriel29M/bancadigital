const CACHE_VERSION = "banca-digital-shell-v702-entity-settings-protected";
const SHELL_CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./", "./index.html", "./css/style.css?v=2.2.10.269-home-explore-entity-safe",
  "./js/app.js?v=2.2.10.553-entity-settings-protected", "./js/reader-deps.js?v=3-reader-split", "./js/catalog-sync.js?v=5-catalog-created-at",
